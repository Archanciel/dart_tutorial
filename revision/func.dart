...
positionalNonNullableAndPositionalNullableDefValArguments
positionalNonNullableAndPositionalNullableArguments
*/
...
void main() {
  ...
  print(positionalNonOptionalNullableNoDefValArguments(null, null)); // 2
  ...
  print(positionalOptionalNullableDefValArguments()); // 2
  ...
  print(positionalOptionalNullableNoDefValArguments()); // 2
...
//                            int error msg
  ...
  double positionalNonNullableAndPositionalNullableArguments(double percent,
      [int? one, double? two]) {
    // no default value arguments, compensated by using ?? null operator
  ...
  print(positionalNonNullableAndPositionalNullableArguments(10, 67)); // 13.4
  print(positionalNonNullableAndPositionalNullableArguments(10, 1, 67)); // 6.7
...
//                            int error msg
  ...
  positionalNonOptionalNullableDefValArguments();
}